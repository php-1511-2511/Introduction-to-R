...
submit_log <- function(){
  ...
  pre_fill_link <-  "https://docs.google.com/a/brown.edu/forms/d/e/1FAIpQLSdVzSefseCMXW9cBLJGflowamr1C772kGJsoRRjs8-ImkIllQ/viewform?usp=pp_url&entry.860602627"
